...
| Research-alpha scaffold versus native FHE lane | `prototype/README.md`, `docs/prototype-map.md`, and `docs/dependency-matrix.md`. | Native-library evidence when the dependency-free scaffold cannot support the claim. |
