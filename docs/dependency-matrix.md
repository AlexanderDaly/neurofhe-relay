...
| `.github/dependabot.yml` | Weekly grouped dependency update routing for GitHub Actions and npm metadata. | Maintenance PR prompts; not release evidence by themselves. |
